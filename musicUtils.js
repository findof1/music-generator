...
export function canPushQ(counter, length){
  return counter + 4 > length * maximumNoteSubdivision
}

export function canPush8th(counter, length){
  return counter + 2 > length * maximumNoteSubdivision
}

export function canPush16th(counter, length){
  return counter + 1 > length * maximumNoteSubdivision
}
...
export function getNoteOptionsByDifficulty(difficulty) {
  const options = {
    1: { lengths: ["w", "h"], values: [16, 8] },
    2: { lengths: ["w", "h", "q"], values: [16, 8, 4] },
    3: { lengths: ["w", "h", "q", "8"], values: [16, 8, 4, 2] },
    4: { lengths: ["w", "h", "q", "8"], values: [16, 8, 4, 2] },
    5: { lengths: ["w", "h", "q", "8"], values: [16, 8, 4, 2] },
    6: { lengths: ["w", "h", "q", "8", "16"], values: [16, 8, 4, 2, 1] },
    7: { lengths: ["w", "h", "q", "8", "16"], values: [16, 8, 4, 2, 1] },
  };
